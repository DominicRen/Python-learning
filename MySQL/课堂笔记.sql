...
-- 数据表的操作
    ...
    insert into students(id, name, age, high, cls_id) values(0, "老李", 18, 188.88, 0);
...
-- 数据的增删改查(curd)
    ...
    -- 修改
        ...
        update students set gender=2 where name="小李飞刀"; -- 只要name是小李飞刀的 全部的修改
    ...
    -- 查询基本使用
        ...
        select * from students where id>3; -- 查询指定id所有信息
